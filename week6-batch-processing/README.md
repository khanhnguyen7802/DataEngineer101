...
> _Resilient Distributed Datasets (RDD)_ is a fundamental data structure of Spark. It is an immutable distributed collection of objects. Each datasets in RDD is divided into **logical partitions**, which may be computed on different nodes of the cluster.
...
Refer to [spark_installation.md](./spark_installation.md).
